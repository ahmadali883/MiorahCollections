        ...
        {userInfo ? (
                ...
                {loading ? (
                  <>
                    <p className="text-grayish-blue">
                      Please hold while your order is being created...
                    </p>
                  </>
                ) : (
                  <div className="mt-8">
                    <p className="text-grayish-blue mb-8">
                      Congratulations! Your order has been placed and will be delivered to your address. You will pay in cash upon delivery.
                    </p>
          ...
          <>
            <p className="text-grayish-blue my-8">
              Congratulations! Your order has been placed and will be delivered to your address. You will pay in cash upon delivery. Be sure to check your emails for order updates.
            </p>
          </>
        )}
      </div>
